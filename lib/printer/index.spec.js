...
test('happy-mark: printer: inlineCode', (t) => {
...
test('happy-mark: printer: link', (t) => {
...
test('happy-mark: printer: link with title', (t) => {
...
test('happy-mark: printer: image with title', (t) => {
...
test('happy-mark: printer: bold in link', (t) => {
...
test('happy-mark: printer: link no text', (t) => {
    const result = printMarkdown(parseMarkdown('[](url)'));
    const expected = '[](url)';
...
test('happy-mark: printer: codeblock and then heading', (t) => {
    const source = montag`
        \`\`\`js
        const a = 3;
        \`\`\`
